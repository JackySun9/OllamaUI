...
class StableDiffusionAPI(ls.LitAPI):
    ...
    def decode_request(self, request):
        ...
        return {
            ...
            "num_inference_steps": request.get("num_inference_steps", 8),
            "guidance_scale": request.get("guidance_scale", 1.5),
...
if __name__ == "__main__":
    ...
    # Changed port to 8001 to avoid conflict with main API server
